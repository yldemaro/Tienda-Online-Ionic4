...
export class DetailsPage implements OnInit {
  ...
  getData() {
    ...
    this.validations_form = this.formBuilder.group({
      ...
      categoria: new FormControl(this.item.categoria, Validators.required)
    });
  }
  ...
  onSubmit(value) {
    ...
    this.firebaseService.updateTask2(this.item.id, data);
    ...
    const alert = await this.alertCtrl.create({
      ...
      buttons: [
        ...
        },
        {
          text: 'Yes',
          handler: () => {
            this.firebaseService.deleteTask2(this.item.id);
